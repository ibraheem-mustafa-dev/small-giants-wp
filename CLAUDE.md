...
| [`.claude/plans/archive/2026-07-04-new-engine-to-parity-delete-converter-v2.md`](.claude/plans/archive/2026-07-04-new-engine-to-parity-delete-converter-v2.md) | **Converter completion plan — EXECUTED IN FULL (D276, 2026-07-05); historical. Live front = the post-programme QC (next-session-prompt.md)** |
