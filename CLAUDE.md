...
- **Next session opening task:** FR-22-20 universal variant detection — build `blocks.variant_attr` column + `variant_slots` table + converter detector + revert hero `$is_split` band-aid. See Spec 22 §FR-22-20 + D133 + parking P-FR2220-VARIANT-DETECTION.
