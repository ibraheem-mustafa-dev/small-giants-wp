...
function sgs_get_fx_qualifying_blocks() {
	...
	if ( null === $map ) {
		$map = array(
			'sgs/before-after' => array( 'draggable', 'morph', 'motion-path', 'scrub' ),
			'sgs/buybox' => array( 'morph', 'motion-path', 'scrub' ),
			...
			'sgs/gallery' => array( 'morph', 'motion-path', 'scrub' ),
			'sgs/google-reviews' => array( 'morph', 'motion-path', 'scrub' ),
			...
			'sgs/info-box' => array( 'morph', 'motion-path', 'scramble', 'scrub', 'split-reveal' ),
			'sgs/label' => array( 'morph', 'motion-path', 'scramble', 'scrub', 'split-reveal' ),
			'sgs/post-grid' => array( 'morph', 'motion-path', 'scrub' ),
			...
			'sgs/product-faq' => array( 'morph', 'motion-path', 'scramble', 'scrub', 'split-reveal' ),
			...
			'sgs/testimonial' => array( 'morph', 'motion-path', 'scramble', 'scrub', 'split-reveal' ),
			'sgs/text' => array( 'morph', 'motion-path', 'scramble', 'scrub', 'split-reveal' ),
			'sgs/timeline' => array( 'draggable', 'morph', 'motion-path', 'scramble', 'scrub', 'split-reveal' ),
			'sgs/trust-bar' => array( 'draw', 'horizontal-panel', 'morph', 'motion-path', 'pin-scrub', 'scramble', 'scrub', 'split-reveal' ),
			'sgs/trustpilot-reviews' => array( 'morph', 'motion-path', 'scrub' ),
