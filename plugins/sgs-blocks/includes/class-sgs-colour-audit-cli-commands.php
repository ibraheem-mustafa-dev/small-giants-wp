...
final class Sgs_Colour_Audit_Cli_Commands {
	...
	private const COLOUR_ATTRIBUTES_BY_BLOCK = array(
		...
		'sgs/choice-flow'        => array( 'backColourBackground', 'backColourBackgroundHover', 'backColourBorder', 'backColourBorderHover', 'backColourText', 'backColourTextHover' ),
		...
		'sgs/nav-bar-menu'       => array( 'burgerBg', 'burgerColour', 'burgerColourGradient', 'burgerColourHover', 'burgerHoverColour', 'featuredBg', 'featuredBgHover', 'featuredColour', 'featuredColourGradient', 'featuredColourHover', 'itemBg', 'itemBgCurrent', 'itemBgHover', 'itemBorderColour', 'itemBorderColourCurrent', 'itemBorderColourHover', 'itemColour', 'itemColourCurrent', 'itemColourGradient', 'itemColourHover', 'itemColourHoverGradient', 'itemSeparatorColour', 'itemSeparatorColourHover', 'navBg', 'navBgHover', 'navColour', 'navColourGradient', 'navColourHover', 'submenuBg', 'submenuBorderColour', 'submenuBorderColourGradient', 'submenuColour', 'submenuColourCurrent', 'submenuColourGradient', 'submenuColourHover', 'submenuLinkBg', 'submenuLinkBgCurrent', 'submenuLinkBgHover', 'submenuLinkBorderColour', 'submenuLinkBorderColourHover', 'submenuShadowColour' ),
		'sgs/nav-drawer'         => array( 'borderColour', 'borderColourGradient', 'drawerBg', 'drawerTextColour', 'drawerTextColourGradient', 'drawerTextColourHover', 'drawerTextColourHoverGradient', 'surfaceOpacity', 'toggleCloseColour', 'toggleCloseColourGradient', 'toggleCloseColourHover', 'toggleCloseColourHoverGradient' ),
		'sgs/nav-drawer-menu'    => array( 'featuredBg', 'featuredBgHover', 'featuredColour', 'featuredColourGradient', 'featuredColourHover', 'itemBg', 'itemBgCurrent', 'itemBgHover', 'itemBorderColour', 'itemBorderColourCurrent', 'itemBorderColourHover', 'itemColour', 'itemColourCurrent', 'itemColourGradient', 'itemColourHover', 'itemColourHoverGradient', 'navBg', 'navBgHover', 'navColour', 'navColourGradient', 'navColourHover', 'submenuBg', 'submenuBorderColour', 'submenuBorderColourGradient', 'submenuColour', 'submenuColourCurrent', 'submenuColourGradient', 'submenuColourHover', 'submenuLinkBg', 'submenuLinkBgCurrent', 'submenuLinkBgHover', 'submenuLinkBorderColour', 'submenuLinkBorderColourHover' ),
		...
		'sgs/responsive-logo'    => array( 'backgroundColour', 'backgroundColourHover', 'borderColour', 'borderColourGradient', 'borderColourHover', 'borderColourHoverGradient' ),
