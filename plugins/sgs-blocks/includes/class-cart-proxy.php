...
require_once __DIR__ . '/class-cart-limits.php';
require_once __DIR__ . '/class-cart-cache-purge.php';

/**
 * Class Cart_Proxy
 *
 * Registers POST /sgs/v1/cart/add-item. Delegates cart-limit enforcement
 * to Cart_Limits and cache-purge hooks to Cart_Cache_Purge.
 */
final class Cart_Proxy {
	...
	public static function register(): void {
		...
		Cart_Cache_Purge::register();
		Cart_Limits::register();
	}
