 ...
 * `color-palette/utils.ts`), commit 28c0dedc4eaf001a24237a1fbba4b0887698b000
 * (WP 7.0.4).
 *
 ...
 * @return {boolean} A boolean indicating whether the color value is a simple CSS color.
 */
...
export const isMultiplePaletteObject = ( obj ) =>
	Array.isArray( obj.colors ) && ! ( 'color' in obj );
 ...
 *
 * @param {string|undefined}    value   The color value that may be a CSS variable.
 * @param {HTMLElement|null}    element The element for which to get the computed style.
 * @return {string|undefined} The background color value computed from a element.
 */
