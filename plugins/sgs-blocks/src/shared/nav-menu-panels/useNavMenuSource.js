...
/**
 * Resolves the classic/block menu source for the caller block (sgs/nav-bar-menu
 * or sgs/nav-drawer-menu) — the menu picker options, the flattened
 * featured-item checklist, and the toggle handler.
 *
