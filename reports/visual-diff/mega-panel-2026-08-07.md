...
0 pass / 1 fail. Child text 1.59:1 against a TRANSLUCENT background (color(srgb … / 0.92)); the effective-background walk cannot composite that, so treat the ratio as indicative. Unchanged by this work.
