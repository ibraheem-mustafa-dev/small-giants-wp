# Visual diff — sgs/testimonial — 2026-09-03

verdict: PASS
intent_capture_passed: true
source_sha: e2df4d4e621fc2c0
...
No live populated testimonial instance found on the canary's current content to capture directly
(the canary is a small demo site; not every migrated block has a content-bearing example live). Verified instead:
(1) the compiled frontend stylesheet (`build/blocks/testimonial/style-index.css`) contains zero literal `object-fit`/
