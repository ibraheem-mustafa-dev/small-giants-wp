---
doc_type: reference
title: "Visual-diff report — site-header-row · gap"
block: site-header-row
date: 2026-08-11
property: gap
verdict: PASS
first_paint_capture_passed: true
source_sha: e4b3e20f884bcb42
---

# site-header-row — Spec 35 pass 1 — `gap` migrated to the tier-object shape, editor control migrated with it, bare number now means px
...
- **Selector (scoped):** `#tierfx-default-site-header .wp-block-sgs-site-header-row` — resolved to `<div>`, uid `sgs-container--grid sgs-container-7b5396cc`
- **CSS property:** `gap`
...
|---|---|---|---|---|---|---|
| desktop (1440px) | `desktop` | `normal` | `normal` | `16px` | `16px` | `block` |
| tablet (900px) | `tablet` | `normal` | `normal` | `16px` | `16px` | `block` |
| mobile (390px) | `mobile` | `normal` | `normal` | `9.13px` | `9.13px` | `block` |
