# Visual diff — sgs/brand-strip — 2026-09-03

verdict: PASS
intent_capture_passed: true
source_sha: 566d91e3f8c97fab
...
No live populated brand-strip instance found on the canary's current content to capture directly
(the canary is a small demo site; not every migrated block has a content-bearing example live). Verified instead:
(1) the compiled frontend stylesheet (`build/blocks/brand-strip/style-index.css`) contains zero literal `object-fit`/
