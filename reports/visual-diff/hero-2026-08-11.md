---
doc_type: reference
title: "Visual-diff report — hero · columns"
block: hero
date: 2026-08-11
property: columns
verdict: PASS
first_paint_capture_passed: true
source_sha: c1778108956626a9
---

# hero — columns binds live at every tier
...
| mobile | outer | grid | `358px` | grid | `44.75px 44.75px 44.75px 44.75px 44.75px 44.75px 44.75px 4...` |
