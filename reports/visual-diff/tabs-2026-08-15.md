# Visual diff — sgs/tabs — 2026-08-15

verdict: PASS
intent_capture_passed: true
source_sha: 7ffbd0cd1720311f
...
(tabs (InnerBlocks children)) is absent — a pre-existing behaviour, unrelated to this migration. Since `git diff
...
of `sgs/tabs` inserted with default (empty) attributes renders nothing — confirmed via direct
