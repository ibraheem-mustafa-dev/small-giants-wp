---
doc_type: reference
title: "Visual-diff report — responsive-logo · maxWidth"
block: responsive-logo
date: 2026-08-11
property: maxWidth
verdict: PASS
first_paint_capture_passed: true
source_sha: ee3738a65adb982f
---

# responsive-logo — Spec 35 pass 2 - maxWidth + contentWidth migrated to the tier-object shape, editor controls migrated in the same commit
...
- **Selector (scoped):** `#tierfx-default-responsive-logo > .wp-block-sgs-responsive-logo` — resolved to `<div>`, uid `(no uid class)`
...
|---|---|---|---|---|---|---|
| desktop (1440px) | `desktop` | `100%` | `100%` | `—` | `—` | `inline-block` |
| tablet (900px) | `tablet` | `100%` | `100%` | `—` | `—` | `inline-block` |
| mobile (390px) | `mobile` | `100%` | `100%` | `—` | `—` | `inline-block` |
