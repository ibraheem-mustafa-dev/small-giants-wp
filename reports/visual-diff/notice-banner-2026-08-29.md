# Visual diff — sgs/notice-banner — 2026-08-29

verdict: PASS
intent_capture_passed: true
source_sha: cb6c9559c2e07f59
...
`sgs/notice-banner` has no hardcoded CSS border declaration on the same selector its
...
Measured via `check-border-roundtrip.js --blocks sgs/notice-banner` (the live
