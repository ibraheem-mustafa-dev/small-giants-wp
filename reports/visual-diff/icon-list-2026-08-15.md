# Visual diff — sgs/icon-list — 2026-08-15

verdict: PASS
intent_capture_passed: true
source_sha: 278478c679d8c89f
...
of `sgs/icon-list` inserted with default attributes. Root element: no inline `style` attribute at
