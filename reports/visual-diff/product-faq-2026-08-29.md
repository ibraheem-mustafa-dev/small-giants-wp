# Visual diff — sgs/product-faq — 2026-08-29

verdict: PASS
intent_capture_passed: true
source_sha: fddc6bcfc590efd7
...
`sgs/product-faq` has no hardcoded CSS border declaration on the same selector its
...
Measured via `check-border-roundtrip.js --blocks sgs/product-faq` (the live
