---
doc_type: reference
title: "Visual-diff report — google-reviews · gap"
block: google-reviews
date: 2026-08-11
property: gap
verdict: PASS
first_paint_capture_passed: true
source_sha: 38853f49c0df29bb
---

# google-reviews — Spec 35 pass 1 — `gap` migrated to the tier-object shape, editor control migrated with it, bare number now means px
...
- **Selector (scoped):** `#tierfx-default-google-reviews > .wp-block-sgs-google-reviews` — resolved to `<div>`, uid `sgs-container--grid sgs-container-debe8f9c`
- **CSS property:** `gap`
