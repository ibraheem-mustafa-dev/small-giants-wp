---
doc_type: reference
title: "Visual-diff report — google-reviews · columns"
block: google-reviews
date: 2026-08-11
property: columns
verdict: PASS
first_paint_capture_passed: true
source_sha: 9d0f5f67aa40338a
---

# google-reviews — columns binds live at every tier
...
|---|---|---|---|---|---|
| desktop | outer | grid | `400px 400px 400px` | grid | `18.75px 18.75px 18.75px 18.75px 18.75px 18.75px 18.75px 1...` |
