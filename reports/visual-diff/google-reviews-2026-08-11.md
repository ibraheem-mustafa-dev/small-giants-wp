---
doc_type: reference
title: "Visual-diff report — google-reviews · gridTemplateColumns"
block: google-reviews
date: 2026-08-11
property: gridTemplateColumns
verdict: PASS
first_paint_capture_passed: true
source_sha: d3fc991922453fee
---

# google-reviews — Spec 35 pass 3a - gridTemplateColumns migrated to the tier-object shape, controls migrated in the same commit, 15 theme values folded into the object
...
- **Selector (scoped):** `#tierfx-default-google-reviews > .wp-block-sgs-google-reviews` — resolved to `<div>`, uid `sgs-container--grid sgs-container-26313410`
