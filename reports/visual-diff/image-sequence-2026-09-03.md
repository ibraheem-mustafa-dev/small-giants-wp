# Visual diff — sgs/image-sequence — 2026-09-03

verdict: PASS
intent_capture_passed: true
source_sha: 953a4e3396863114
...
No live populated image-sequence instance found on the canary's current content to capture directly
(the canary is a small demo site; not every migrated block has a content-bearing example live). Verified instead:
(1) the compiled frontend stylesheet (`build/blocks/image-sequence/style-index.css`) contains zero literal `object-fit`/
