---
doc_type: reference
title: "Visual-diff report — before-after · maxWidth"
block: before-after
date: 2026-08-11
property: maxWidth
verdict: PASS
first_paint_capture_passed: true
source_sha: 93a9d76fa58cd607
---

# before-after — Spec 35 pass 2 - maxWidth migrated to the tier-object shape; measured on a media-bearing probe page because these two blocks render no element without media
...
- **Page:** https://sandybrown-nightingale-600381.hostingersite.com/tier-fixture-maxwidth-media/
- **Selector (scoped):** `#tierfx2-default-before-after .wp-block-sgs-before-after` — resolved to `<div>`, uid `(no uid class)`
