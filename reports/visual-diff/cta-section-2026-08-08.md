---
doc_type: reference
title: "Visual-diff / LANDED report — sgs/cta-section Settings/Styles inspector tab split"
block: sgs/cta-section
date: 2026-08-08
wave: "Spec 35 Task 3 batch A — 01-tab-group backlog, behaviour→Settings / appearance→Styles"
verdict: PASS
first_paint_capture_passed: true
source_sha: 2e71b6872aa93f0f
---

# sgs/cta-section — inspector tab split (EDITOR-ONLY change)

**Verdict: PASS**, on the specific ground this gate protects: **the frontend render surface did
not change.** `src/blocks/cta-section/edit.js` is the ONLY file touched — `render.php`,
...
Now: **2 panel(s) in Settings, 9 in Styles**, using
...
Panel splitting: No panel needed splitting — the block divided cleanly into 2 behaviour/content panels and 9 appearance panels.
...
- **Frontend is provably unaffected** — no render-path file was edited. Verified with
  `git status` scoped to `src/blocks/cta-section/`: `edit.js` is the only modified entry.
