# Visual diff — sgs/trustpilot-reviews — 2026-08-29

verdict: PASS
intent_capture_passed: true
source_sha: 6c82e22c201af8a3
...
`sgs/trustpilot-reviews` has no hardcoded CSS border declaration on the same selector its
...
Measured via `check-border-roundtrip.js --blocks sgs/trustpilot-reviews` (the live
