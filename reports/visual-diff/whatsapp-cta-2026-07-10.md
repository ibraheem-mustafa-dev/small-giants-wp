---
doc_type: reference
title: "Visual-diff / LANDED report — sgs/whatsapp-cta no-inline migration"
block: sgs/whatsapp-cta
date: 2026-07-10
...
# sgs/whatsapp-cta — no-inline + box-object migration (LANDED)

**Verdict: PASS.** Migrated block-private to the no-inline styling contract (D294 pattern
selector: single <a> root (button D288 pattern) → block-private). Verified LANDED live on the sandybrown canary test page
...
## Migration summary
- **Supports skip-serialised** (`__experimentalSkipSerialization: true`): spacing, color, __experimentalBorder. render.php reads
...
- Block-specific: collapsed wrapper div to the <a> root; updated 3 variant selectors in style.css to compound
