# Visual diff — sgs/process-steps — 2026-08-15

verdict: PASS
intent_capture_passed: true
source_sha: dedfb6123ced99e5
...
of `sgs/process-steps` inserted with default attributes. Root element: no inline `style` attribute at
