...
2 pass / 1 fail. The failure is .sgs-counter__number at 2.25:1 - brand pink. Both the de-specified rule and the operator's scoped rule resolve to 'primary', so the value is UNCHANGED by this work.
