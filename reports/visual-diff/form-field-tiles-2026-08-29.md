# Visual diff — sgs/form-field-tiles — 2026-08-29

verdict: PASS
intent_capture_passed: true
source_sha: 3938267c7f51d797
...
`sgs/form-field-tiles` has no hardcoded CSS border declaration on the same selector its
...
Measured via `check-border-roundtrip.js --blocks sgs/form-field-tiles` (the live
