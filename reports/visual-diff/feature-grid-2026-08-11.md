---
doc_type: reference
title: "Visual-diff report — feature-grid · gridTemplateColumns"
block: feature-grid
date: 2026-08-11
property: gridTemplateColumns
verdict: PASS
first_paint_capture_passed: true
source_sha: 420f7050dc67ce31
---

# feature-grid — Spec 35 pass 3a - gridTemplateColumns migrated to the tier-object shape, controls migrated in the same commit, 15 theme values folded into the object
...
- **Selector (scoped):** `#tierfx-default-feature-grid > .wp-block-sgs-feature-grid` — resolved to `<div>`, uid `sgs-container--grid sgs-container-92474ca0`
...
|---|---|---|---|---|---|---|
| desktop (1440px) | `desktop` | `282px 282px 282px 282px` | `282px 282px 282px 282px` | `—` | `—` | `grid` |
| tablet (900px) | `tablet` | `414px 414px` | `414px 414px` | `—` | `—` | `grid` |
