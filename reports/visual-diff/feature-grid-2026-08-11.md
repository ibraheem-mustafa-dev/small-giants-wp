---
doc_type: reference
title: "Visual-diff report — feature-grid · gap"
block: feature-grid
date: 2026-08-11
property: gap
verdict: PASS
first_paint_capture_passed: true
source_sha: 5591c0f2d097d6c5
---

# feature-grid — Spec 35 pass 1 — `gap` migrated to the tier-object shape, editor control migrated with it, bare number now means px
...
- **Selector (scoped):** `#tierfx-default-feature-grid > .wp-block-sgs-feature-grid` — resolved to `<div>`, uid `sgs-container--grid sgs-container-73479acd`
- **CSS property:** `gap`
...
|---|---|---|---|---|---|---|
| desktop (1440px) | `desktop` | `24px` | `24px` | `—` | `—` | `grid` |
| tablet (900px) | `tablet` | `24px` | `24px` | `—` | `—` | `grid` |
| mobile (390px) | `mobile` | `16px` | `16px` | `—` | `—` | `grid` |
