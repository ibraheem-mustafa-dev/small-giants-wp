# Visual diff — sgs/info-box — 2026-09-03

verdict: PASS
intent_capture_passed: true
source_sha: 7ee3470bde4dd1d4
...
No live populated info-box instance found on the canary's current content to capture directly
(the canary is a small demo site; not every migrated block has a content-bearing example live). Verified instead:
(1) the compiled frontend stylesheet (`build/blocks/info-box/style-index.css`) contains zero literal `object-fit`/
