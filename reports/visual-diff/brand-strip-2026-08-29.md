# Visual diff — sgs/brand-strip — 2026-08-29

verdict: PASS
intent_capture_passed: true
source_sha: aea998806ce9063b
...
`sgs/brand-strip` has no hardcoded CSS border declaration on the same selector its
...
Measured via `check-border-roundtrip.js --blocks sgs/brand-strip` (the live
