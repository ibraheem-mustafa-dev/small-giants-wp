---
doc_type: reference
title: "Visual-diff report — container · gap"
block: container
date: 2026-08-11
property: gap
verdict: PASS
first_paint_capture_passed: true
source_sha: 55d126b8e94b073f
---

# container — Spec 35 pass 1 — `gap` migrated to the tier-object shape, editor control migrated with it, bare number now means px
...
- **Selector (scoped):** `#tierfx-default-container > .wp-block-sgs-container` — resolved to `<section>`, uid `sgs-container--grid sgs-container-cec5621d`
- **CSS property:** `gap`
