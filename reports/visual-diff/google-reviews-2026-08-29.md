# Visual diff — sgs/google-reviews — 2026-08-29

verdict: PASS
intent_capture_passed: true
source_sha: 71259277e20a54f5
...
`sgs/google-reviews` has no hardcoded CSS border declaration on the same selector its
...
Measured via `check-border-roundtrip.js --blocks sgs/google-reviews` (the live
