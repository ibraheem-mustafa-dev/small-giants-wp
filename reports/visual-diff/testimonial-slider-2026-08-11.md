---
doc_type: reference
title: "Visual-diff report — testimonial-slider · gap"
block: testimonial-slider
date: 2026-08-11
property: gap
verdict: PASS
first_paint_capture_passed: true
source_sha: 948484e7368b80fb
---

# testimonial-slider — Spec 35 pass 1 — `gap` migrated to the tier-object shape, editor control migrated with it, bare number now means px
...
- **Selector (scoped):** `#tierfx-default-testimonial-slider > .wp-block-sgs-testimonial-slider` — resolved to `<div>`, uid `sgs-container--full sgs-container-248aaa60`
- **CSS property:** `gap`
