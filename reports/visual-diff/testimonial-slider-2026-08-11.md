---
doc_type: reference
title: "Visual-diff report — testimonial-slider · columns"
block: testimonial-slider
date: 2026-08-11
property: columns
verdict: PASS
first_paint_capture_passed: true
source_sha: 73dfddd6c9539faa
---

# testimonial-slider — no grid found anywhere for this property (CSS fact)
...
**Not a defect (CSS fact, grid-only property).** renders `display:block` at every viewport with no grid rule found on the outer element or its inner band -- the slider's layout is carousel/JS-driven, not a CSS grid.
