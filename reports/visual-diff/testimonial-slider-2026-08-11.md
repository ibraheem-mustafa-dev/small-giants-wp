---
doc_type: reference
title: "Visual-diff report — testimonial-slider · gridTemplateColumns"
block: testimonial-slider
date: 2026-08-11
property: gridTemplateColumns
verdict: PASS
first_paint_capture_passed: true
source_sha: d61daacd2014fbe9
---

# testimonial-slider — Spec 35 pass 3a - gridTemplateColumns migrated to the tier-object shape, controls migrated in the same commit, 15 theme values folded into the object
...
- **Selector (scoped):** `#tierfx-default-testimonial-slider > .wp-block-sgs-testimonial-slider` — resolved to `<div>`, uid `sgs-container--full sgs-container-8e66a372`
