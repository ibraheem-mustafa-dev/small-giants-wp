---
doc_type: reference
title: "Visual-diff report — accordion · gridTemplateColumns"
block: accordion
date: 2026-08-11
property: gridTemplateColumns
verdict: PASS
first_paint_capture_passed: true
source_sha: f0cb485f10ad91c8
---

# accordion — Spec 35 pass 3a - gridTemplateColumns migrated to the tier-object shape, controls migrated in the same commit, 15 theme values folded into the object
...
- **Selector (scoped):** `#tierfx-default-accordion > .wp-block-sgs-accordion` — resolved to `<div>`, uid `sgs-container--grid sgs-container-980f7786`
