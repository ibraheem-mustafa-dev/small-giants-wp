---
doc_type: reference
title: "Visual-diff report — accordion · gap"
block: accordion
date: 2026-08-11
property: gap
verdict: PASS
first_paint_capture_passed: true
source_sha: 98834da96bb4c1f0
---

# accordion — Spec 35 pass 1 — `gap` migrated to the tier-object shape, editor control migrated with it, bare number now means px
...
- **Selector (scoped):** `#tierfx-default-accordion > .wp-block-sgs-accordion` — resolved to `<div>`, uid `sgs-container--grid sgs-container-789365f9`
- **CSS property:** `gap`
