# Visual diff — sgs/post-grid — 2026-08-15

verdict: PASS
intent_capture_passed: true
source_sha: 4fa5415dcdbf9638
...
of `sgs/post-grid` inserted with default attributes. Root element: no inline `style` attribute at
