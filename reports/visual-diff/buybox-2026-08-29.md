# Visual diff — sgs/buybox — 2026-08-29

verdict: PASS
intent_capture_passed: true
source_sha: 4f80590ecc73b805
...
`sgs/buybox` has no hardcoded CSS border declaration on the same selector its
...
Measured via `check-border-roundtrip.js --blocks sgs/buybox` (the live
