---
doc_type: reference
title: "Visual-diff report — cta-section · gridItemPadding"
block: cta-section
date: 2026-08-13
property: gridItemPadding
verdict: PASS
first_paint_capture_passed: true
source_sha: e8c674d35cdfe359
---

# cta-section — gridItemPadding migrated to responsive {desktop,tablet,mobile} tier object (Bean's ruling: a box-object property should always also be responsive), matching contentBandPadding's established pattern
...
- **Selector (scoped):** `#tierfx-default-cta-section > .wp-block-sgs-cta-section, #tierfx-default-cta-section > .sgs-cta-section` — resolved to `<section>`, uid `sgs-container--grid sgs-container-66de3320`
...
**Evidence:** same as container - mounts gridItemPadding via the shared GridItemDefaultsPanel, not a direct value={} binding in its own edit.js
