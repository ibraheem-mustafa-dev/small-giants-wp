---
doc_type: reference
title: "Visual-diff report — physics-canvas · maxWidth"
block: physics-canvas
date: 2026-08-11
property: maxWidth
verdict: PASS
first_paint_capture_passed: true
source_sha: 72fdb896e2fc86fc
---

# physics-canvas — Spec 35 pass 2 - maxWidth + contentWidth migrated to the tier-object shape, editor controls migrated in the same commit
...
- **Selector (scoped):** `#tierfx-default-physics-canvas > .wp-block-sgs-physics-canvas` — resolved to `<section>`, uid `sgs-container-b137767f`
...
|---|---|---|---|---|---|---|
| desktop (1440px) | `desktop` | `none` | `none` | `none` | `none` | `block` |
| tablet (900px) | `tablet` | `none` | `none` | `none` | `none` | `block` |
| mobile (390px) | `mobile` | `none` | `none` | `none` | `none` | `block` |
...
- desktop: set `64px` → outer `64px`, inner `none`  ✅ binds
- mobile: set `8px` → outer `8px`, inner `none`  ✅ binds
- tablet: set `32px` → outer `32px`, inner `none`  ✅ binds
