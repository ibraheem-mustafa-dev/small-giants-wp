...
# Visual-diff — sgs/feature-grid: dead `direction`/`wrap` attribute deletion — 2026-08-05
...
**What the capture proves for THIS block.** The block IS present on the captured homepage and renders correctly after the deletion: 960 x 177, 332 characters of text — laid out, populated, no collapse.
