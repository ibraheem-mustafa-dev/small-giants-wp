# Visual diff — sgs/post-grid — 2026-09-03

verdict: PASS
intent_capture_passed: true
source_sha: 23318adc93382136
...
No live populated post-grid instance found on the canary's current content to capture directly
(the canary is a small demo site; not every migrated block has a content-bearing example live). Verified instead:
(1) the compiled frontend stylesheet (`build/blocks/post-grid/style-index.css`) contains zero literal `object-fit`/
