# site-footer-row — visual-diff report (2026-08-06)
...
12 container-mirror attrs declared.
...
selector : .sgs-site-footer-row
result   : [PASS] content server-rendered and VISIBLE with JS off — 3/3 items visible
