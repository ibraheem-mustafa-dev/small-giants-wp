---
doc_type: reference
title: "Visual-diff report — gallery · columns"
block: gallery
date: 2026-08-11
property: columns
verdict: PASS
first_paint_capture_passed: true
source_sha: a5d9bf721008f177
---

# gallery — columns binds live at every tier
...
|---|---|---|---|---|---|
| desktop | inner (__inner band) | grid | `389.328px 389.328px 389.328px` | grid | `3px 3px 3px 3px 3px 3px 3px 3px 3px 3px 3px 3px 3px 3px 3...` |
| tablet | inner (__inner band) | grid | `418px 418px` | grid | `11.125px 11.125px 11.125px 11.125px 11.125px 11.125px 11....` |
| mobile | inner (__inner band) | grid | `342px` | grid | `28.75px 28.75px 28.75px 28.75px 28.75px 28.75px 28.75px 2...` |
