# site-header-row — visual-diff report (2026-08-06)
...
13 container-mirror attrs declared.
...
selector : .sgs-site-header-row
result   : [PASS] content server-rendered and VISIBLE with JS off — 2/2 items visible
