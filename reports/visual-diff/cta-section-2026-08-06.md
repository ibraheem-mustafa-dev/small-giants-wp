# cta-section — visual-diff report (2026-08-06)
...
```
url      : https://sandybrown-nightingale-600381.hostingersite.com/sgs-gate-canary-2/
selector : .sgs-cta-section
...
Playwright live DOM: block present, innerText 85 chars, computed `--sgs-transition-duration` = **300ms**, `--sgs-transition-easing` = **ease-in-out**. **This is the load-bearing proof for all six transition cleanups** — it shows the helper, not the deleted local, is what emits them.
