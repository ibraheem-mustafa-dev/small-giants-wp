...
# sgs/cta-section — focus-ring token repoint (D467 sweep)

## What changed

One line in `src/blocks/cta-section/style.css`, inside the existing `:focus-visible` rule. No
...
`curl https://sandybrown-nightingale-600381.hostingersite.com/wp-content/plugins/sgs-blocks/build/blocks/cta-section/style-index.css`:
...
= `#f5d050` on this client. `sgs/cta-section` was not present on the homepage at verification time
