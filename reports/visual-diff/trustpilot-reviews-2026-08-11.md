---
doc_type: reference
title: "Visual-diff report — trustpilot-reviews · gridTemplateColumns"
block: trustpilot-reviews
date: 2026-08-11
property: gridTemplateColumns
verdict: PASS
first_paint_capture_passed: true
source_sha: 2bd789db719586dc
---

# trustpilot-reviews — Spec 35 pass 3a - gridTemplateColumns migrated to the tier-object shape, controls migrated in the same commit, 15 theme values folded into the object
...
- **Selector (scoped):** `#tierfx-default-trustpilot-reviews > .wp-block-sgs-trustpilot-reviews` — resolved to `<div>`, uid `sgs-container--grid sgs-container-80677a7c`
...
|---|---|---|---|---|---|---|
| desktop (1440px) | `desktop` | `400px 400px 400px` | `400px 400px 400px` | `—` | `—` | `grid` |
