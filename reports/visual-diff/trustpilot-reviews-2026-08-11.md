---
doc_type: reference
title: "Visual-diff report — trustpilot-reviews · gap"
block: trustpilot-reviews
date: 2026-08-11
property: gap
verdict: PASS
first_paint_capture_passed: true
source_sha: e521592a995d58a0
---

# trustpilot-reviews — Spec 35 pass 1 — `gap` migrated to the tier-object shape, editor control migrated with it, bare number now means px
...
- **Selector (scoped):** `#tierfx-default-trustpilot-reviews > .wp-block-sgs-trustpilot-reviews` — resolved to `<div>`, uid `sgs-container--grid sgs-container-3177b4f9`
- **CSS property:** `gap`
