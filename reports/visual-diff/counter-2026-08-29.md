# Visual diff — sgs/counter — 2026-08-29

verdict: PASS
intent_capture_passed: true
source_sha: 8a2fd44bf4deab7c
...
`sgs/counter` has no hardcoded CSS border declaration on the same selector its
...
Measured via `check-border-roundtrip.js --blocks sgs/counter` (the live
