---
doc_type: reference
title: "Visual-diff / LANDED report — sgs/star-rating no-inline migration"
...
# sgs/star-rating — no-inline + box-object migration (LANDED)
...
- Block-specific: SVG fill/size moved to scoped rule; Schema.org rating preserved
