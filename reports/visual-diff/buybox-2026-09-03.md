# Visual diff — sgs/buybox — 2026-09-03

verdict: PASS
intent_capture_passed: true
source_sha: d4d356a62adf1df5
...
No live populated buybox instance found on the canary's current content to capture directly
(the canary is a small demo site; not every migrated block has a content-bearing example live). Verified instead:
(1) the compiled frontend stylesheet (`build/blocks/buybox/style-index.css`) contains zero literal `object-fit`/
