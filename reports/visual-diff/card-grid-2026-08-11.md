---
doc_type: reference
title: "Visual-diff report — card-grid · columns"
block: card-grid
date: 2026-08-11
property: columns
verdict: PASS
first_paint_capture_passed: true
source_sha: 519359a567f70230
---

# card-grid — columns binds live at every tier
...
|---|---|---|---|---|---|
| desktop | outer | grid | `389.328px 389.328px 389.344px` | grid | `3px 3px 3px 3px 3px 3px 3px 3px 3px 3px 3px 3px 3px 3px 3...` |
| tablet | outer | grid | `418px 418px` | grid | `11.125px 11.125px 11.125px 11.125px 11.125px 11.125px 11....` |
| mobile | outer | grid | `342px` | grid | `28.75px 28.75px 28.75px 28.75px 28.75px 28.75px 28.75px 2...` |
