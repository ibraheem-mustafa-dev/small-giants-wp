 ...
 * Slug: sgs/pricing-columns
 * Categories: sgs
 * Description: Three-column pricing table with highlighted middle column.
 *
 * @package SGS\Theme
 */
?>

<!-- wp:sgs/container {"tagName":"div","align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}}},"backgroundColour":"surface-alt","contentWidth":{"desktop":"normal"}} -->
	...
	<!-- wp:sgs/container {"layout":"grid","gridTemplateColumns":{"desktop":"1fr 1fr 1fr","mobile":"1fr"},"align":"wide","gap":{"desktop":"var:preset|spacing|40"}} -->
		...
		<!-- wp:sgs/container -->
			<!-- wp:sgs/container {"tagName":"div","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}},"border":{"radius":"12px"}},"backgroundColour":"surface"} -->
				<!-- wp:sgs/heading {"content":"Starter","textAlign":"center","level":"h3","fontSize":{"desktop":"large"}} /-->
				<!-- wp:sgs/text {"text":"<strong>£997</strong>","textAlign":"center","fontSize":{"desktop":"xx-large"},"style":{"spacing":{"margin":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20"}}}} /-->
		...
		<!-- wp:sgs/container -->
			<!-- wp:sgs/container {"tagName":"div","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}},"border":{"radius":"12px","width":"2px","color":"var:preset|color|primary"}},"backgroundColour":"surface"} -->
				...
				<!-- wp:sgs/text {"text":"<strong>£2,497</strong>","textAlign":"center","fontSize":{"desktop":"xx-large"},"style":{"spacing":{"margin":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20"}}}} /-->
				<!-- wp:sgs/text {"text":"For growing businesses that need more power and flexibility.","textAlign":"center","textColour":"text-muted","fontSize":{"desktop":"small"}} /-->
				<!-- wp:sgs/separator {"style":{"spacing":{"margin":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}}} /-->
				<!-- wp:list {"style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"textColor":"text-muted"} -->
				<ul class="has-text-muted-color has-text-color"><!-- wp:list-item -->
		...
		<!-- wp:sgs/container -->
			<!-- wp:sgs/container {"tagName":"div","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}},"border":{"radius":"12px"}},"backgroundColour":"surface"} -->
				...
				<!-- wp:sgs/text {"text":"<strong>Custom</strong>","textAlign":"center","fontSize":{"desktop":"xx-large"},"style":{"spacing":{"margin":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20"}}}} /-->
