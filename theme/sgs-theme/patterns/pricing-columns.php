...
<!-- wp:sgs/container {"tagName":"div","backgroundColour":"surface-alt","contentWidth":{"desktop":"normal"},"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"flexWrap":"wrap","templateLock":"contentOnly"} -->
	...
	<!-- wp:sgs/heading {"content":"Simple, Transparent Pricing","textAlign":"center","fontSize":{"desktop":"xx-large"},"margin":{"bottom":"var:preset|spacing|60"}} /-->
	...
	<!-- wp:sgs/container {"layout":"grid","gridTemplateColumns":{"desktop":"1fr 1fr 1fr","mobile":"1fr"},"gap":{"desktop":"var:preset|spacing|40"}} -->
		...
		<!-- wp:sgs/container -->
			<!-- wp:sgs/container {"tagName":"div","backgroundColour":"surface","padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"flexWrap":"wrap","borderRadius":{"desktop":"12px"}} -->
				...
				<!-- wp:sgs/separator {"margin":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}} /-->
