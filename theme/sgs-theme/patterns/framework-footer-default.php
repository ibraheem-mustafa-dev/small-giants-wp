...
<!-- wp:sgs/site-footer {"align":"full","backgroundColour":"footer-bg","contentWidth":{"desktop":"normal"},"padding":{"top":"var:preset|spacing|50","right":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40"}} -->
	...
	<!-- wp:sgs/site-footer-row {"rowSlot":"columns","layout":"grid","gridTemplateColumns":{"desktop":"2fr 1fr 1fr","mobile":"1fr"},"gap":{"desktop":"48px","mobile":"32px"},"alignItems":"top"} -->
		...
		<!-- wp:sgs/container {"tagName":"div","metadata":{"name":"Brand"},"layout":"stack","flexWrap":"wrap"} -->

			<!-- wp:sgs/responsive-logo {"width":180,"linkToHome":true,"margin":{"bottom":"var:preset|spacing|30"}} /-->

			<!-- wp:sgs/business-info {"displayType":"description","textColour":"surface","fontSize":{"desktop":"regular"},"margin":{"bottom":"var:preset|spacing|30"}} /-->
	...
	<!-- wp:sgs/site-footer-row {"borderWidth":{"top":"1px"},"borderStyle":"solid","borderColour":"accent","rowSlot":"bottom","layout":"flex","justifyContent":"space-between","alignItems":"center","flexWrap":"wrap","gap":{"desktop":"8px"},"padding":{"desktop":{"top":"var(--wp--preset--spacing--40)","bottom":"var(--wp--preset--spacing--40)"}}} -->
