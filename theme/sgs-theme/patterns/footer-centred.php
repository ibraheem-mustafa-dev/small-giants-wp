 ...
 * Description: Centred footer with logo area, navigation links, and copyright. Content auto-populates from Settings > Business Details. Starter template for the sgs_footer CPT, built on sgs/site-footer with a single-column "columns" row.
 *
 * @package SGS\Theme
 */
...
<!-- wp:sgs/site-footer-row {"borderWidth":{"top":"1px"},"borderStyle":"solid","borderColour":"border","rowSlot":"bottom","layout":"flex","justifyContent":"center","padding":{"desktop":{"top":"var(--wp--preset--spacing--20)","bottom":"var(--wp--preset--spacing--20)"}}} -->
