 ...
 * Description: A full-screen panel over the dimmed page, a plain left-aligned link list and a social row. Reference: a real-site full-viewport editorial drawer.
 *
 * @package SGS\Theme
 */
...
<!-- wp:sgs/social-icons /-->
<!-- wp:sgs/text {"text":"See our latest work."} /-->
<!-- /wp:sgs/nav-drawer -->
