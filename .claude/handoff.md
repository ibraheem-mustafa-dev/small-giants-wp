...
13. **180 Spec 15 citations repointed** across 87 files **including the generator** (`generate-block-reference.py`), so it survives `/sgs-update`. Mapping derived from the spec recovered out of git, not guessed.
