...
> **Status:** OPEN (fix-shape LOCKED = §FR-22-19 H-conv; build pending — sensitive walker work, focused session per STOP #19) · **Bucket:** Pipeline / converter · **Trigger:** next focused session (highest priority).
...
> **Status:** OPEN (fix-shape = dual-mode §FR-24-10; build pending — focused session after hero) · **Bucket:** Block migration (dual-mode) · **Trigger:** focused session after hero §FR-22-19.
