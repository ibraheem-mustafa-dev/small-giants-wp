...
> **P-CONTAINER-WRAPPER-STANDARDISATION** — NEW 2026-06-02 (D152); **WS-1 A1+A2 SHIPPED 2026-06-03 (D159, `2f86d9e6`).** **Status: PARTIAL** (pipeline/converter — PROGRAMME). The container/wrapper CSS-transfer system is a faithful-transfer failure, composites don't mirror `sgs/container`, and no auto-propagation path exists.
>
