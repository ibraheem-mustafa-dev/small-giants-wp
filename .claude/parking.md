...
> **Common thread: #4+#9 are the SAME "hardcoded wrapper default is a cheat to remove" class (D228); #1 is a distinct converter gate bug.** Fix phase (Phase 3/4) queued — agree fix-shapes with Bean first.
