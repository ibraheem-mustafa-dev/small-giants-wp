...
> **P-CONTAINER-WRAPPER-STANDARDISATION** — NEW 2026-06-02 (D152). **Status: OPEN** (pipeline/converter — PROGRAMME). The container/wrapper CSS-transfer system is a faithful-transfer failure, composites don't mirror `sgs/container`, and no auto-propagation path exists.
>
