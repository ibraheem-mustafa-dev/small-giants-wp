...
> **Status: OPEN** · **Bucket:** Cloning pipeline / fidelity · **Trigger:** next session (the discrepancy programme — see `next-session-prompt.md`). Full task breakdown + STOP catalogue in the next-session-prompt.
