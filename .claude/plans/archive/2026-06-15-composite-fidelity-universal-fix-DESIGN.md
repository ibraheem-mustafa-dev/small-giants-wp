...
created: 2026-06-15
status: ARCHIVED 2026-06-23 (doc audit) — Wave-A items shipped piecemeal via D228; Wave-B/C converter items absorbed into the clean modular rebuild (Spec 31 §12, convert.py FROZEN per D229 D-MODULAR). The referenced defect register (reports/2026-06-14-clone-vs-draft-defect-register.md) remains live evidence for the rebuild. ORIGINAL: DESIGN — awaiting Bean sign-off before any build. Rule-7 high-blast items flagged for /adversarial-council.
