---
doc_type: plan
title: Dead-pattern-attrs fix — border-mechanism migration for 15 theme patterns
date: 2026-09-07
status: COMPLETE. Task 1 needed no new build (border controls already complete on button/container/media). Task 2 shipped in 4f3127a04, merged to main — all 15 pattern + 6 template files migrated. check-dead-pattern-attrs.py --check: 0 findings (was 40), verified 2026-09-07.
---
