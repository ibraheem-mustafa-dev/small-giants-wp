# [ARCHIVED 2026-04-30] Build Order — Original 4-Phase Plan

> **Status:** Archived. This was the original SGS framework build plan (drafted ~Q4 2025). All four phases shipped. Replaced by the current-roadmap version at `.claude/specs/06-BUILD-ORDER.md` on 2026-04-30. Preserved here for historical context.
