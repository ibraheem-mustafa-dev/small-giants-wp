...
supersedes: plans/archive/2026-07-22-spec36-37-parallel-execution-plan.md (parallel model rejected by DP1);
  plans/archive/2026-07-28-B3-header-footer-style-preset-library-design-gate.md (subsumed — §7 answers in gate §0)
---
