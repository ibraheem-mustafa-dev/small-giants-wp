...
- **STILL-BROKEN (live-evidenced):** P1 margin (IN-B), P2 Fraunces (closed), P3 inner max-width (IN-B/H-C1), P6 text-align (IN-E/GF-B.2 — under re-verify). **1 from this cluster still open:** ~~IN-C~~ CLOSED 2026-06-12 (WS-A dual-key wrapper fallback, live-verified). IN-F content (bg fixed; empty content deferred to universal-lift mechanism). BR-B = media-sideload NOT converter.
