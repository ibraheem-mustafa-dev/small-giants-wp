...
| `custom-css.php:48-53` | **FAILS 4b**, and is **missing the leading-`<style>` skip guard** every sibling extension needed. Never audited, never in any census. **A live latent defect of the same class as image-controls** |
