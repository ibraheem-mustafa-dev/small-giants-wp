...
| Item | Severity | Notes |
|---|---|---|
| ~13 per-block `if slug=="sgs/X"` literal carve-outs in `convert.py` | High | D222 (2026-06-13): de-literalisation programme scoped at `.claude/plans/2026-06-13-converter-de-literalisation-audit.md`. Replacement: universal `_lift_scalar_attrs_by_selector` via `block_attributes.derived_selector`. |
