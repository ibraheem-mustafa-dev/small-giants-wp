...
**Framework stats (headline verified 2026-06-02 — authoritative current counts live in [`../CLAUDE.md`](../CLAUDE.md) "Framework stats"; do not maintain a divergent copy here):** 68 SGS blocks (all dynamic) + 122 core/wp indexed = 190 total; 2,077 block_attributes; `sgs/trust-bar` is ACTIVE (dual-mode sourceMode typed|bound, FR-24-10 2026-06-01); `block_composition.container_kind` column BUILT + 28-block roster populated (D152 2026-06-02). All blocks at `apiVersion: 3`. WP 7.0. (Token/pattern/hook/capability counts: see CLAUDE.md.)
