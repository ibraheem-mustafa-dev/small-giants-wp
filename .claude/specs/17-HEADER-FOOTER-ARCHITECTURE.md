...
- Background content (everything outside the drawer) is unreachable (`inert`/modal-dialog inertness/`aria-hidden`) while the drawer is open; **the drawer itself is never inert**
