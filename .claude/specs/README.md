...
| 43 | [43-SGS-CHOICE-FLOW.md](43-SGS-CHOICE-FLOW.md) (v1.6.0) | `sgs/choice-flow` — the step-wizard block family for qualification quizzes, priced configurators and WooCommerce variation-picking; branching via `nextStepMap`; purchase-ending flows reuse Spec 27's add-to-cart proxy; `sgs_choice_flow` CPT shown by a linked block (FR-43-6); the add-on price list (FR-43-17 to 20); answers and fields carried to the bag line (FR-43-21). Phases 0-2 built; Phase 3's add-on source and Phase 4's FR-43-6 built (the Eye Care lens configurator); the variation source, FR-43-7 and Phase 5 not started | active |
