...
binding_rules: R-31-1, R-31-2, R-31-3, R-31-6, R-31-9, R-31-11, R-31-15
---
...
8. **No destination?** → write to `attribute_gap_candidates` with `proposed_action='add attr: css=… raw=… class=… run=…'`. NEVER silent-drop, NEVER emit as inline `@media` (R-31-6), NEVER fall to D2 scoped CSS when a D1 attr destination exists (R-31-15c).
...
### 7b. The structural-insufficiency rule (R-31-15 / FR-31-18 — load-bearing)
