...
|---|---|---|---|
| OUTER box | the section-root element itself (emitted as the container) | native `style.spacing.*` / `style.background` / `style.border` + `widthMode`·`customWidth` | `paddingTop`, `backgroundColor`, `customWidth` |
