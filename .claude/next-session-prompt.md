...
4. ☐ **`.claude/specs/31-UNIVERSAL-CONTAINER-CSS-TRANSFER.md`** — §3 (content+CSS routing incl. media/image-object, step 7 align gating spec:157/179), §13.2 FR-31-4/4.1 (container default), §13.3 the content fork (FR-31-2 — for #6 product-card recognition), §13.5 FR-31-20 variant detection (for #4 hero split).
