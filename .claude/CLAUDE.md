...
- Recent decisions: see `decisions.md` (current through D167, 2026-06-04 — D167 = WS-4 block-side complete (29-block roster mirrors sgs/container; architecture resolved: docs-are-truth, KIND-scoped full mirror, no per-block trim, blub.db 312); D166 = 25 composites mirrored + shared helper recipe canonical; D159 = WS-1 A1+A2 SHIPPED; D160 = triage #1–#8 grounded + WS-4 all-composites scope confirmed; D153-D158 = theme thread (Spec 26 global styles + per-client theming, build deferred); D152 = container/wrapper standardisation WS-1 SHIPPED + composite-mirror rule locked; D150 = archive-on-resolve standard practice; D57-D65 = 2026-05-24 doc-op programme close)
