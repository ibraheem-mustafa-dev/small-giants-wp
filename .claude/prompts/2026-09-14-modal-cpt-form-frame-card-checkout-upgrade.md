...
Five independent tasks. Work them in order — each later task assumes the earlier ones exist.
...
## Task 3 — brainstorm the real gap between `sgs/form` and the lens flow
