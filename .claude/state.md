...
phase_3_5_summary: "Phase 3.5 (coverage + drift remediation) shipped 2026-05-12 via 5 parallel subagent dispatch. B1+B3 (Gemini Flash) hallucinated reports — redone inline; B2 (Sonnet, render.php mining) verified against source line-by-line; B4 (Sonnet, panel fixes) all 3 verified; B5 (Sonnet, drift remediation) caught a real parents[3]→parents[4] path bug. Outcomes: drift violations 833→23 (97% reduction), canonicalised 309→528 (+219), gap queue 942→719 (-223). Spec §11 amended to allow layout/state/motion slot vocab beyond content-identity. Tier 1 (+13 property_suffixes) + Tier 2 (+10 slot_synonyms) vocab applied. Hero --verify-against still PASS."
