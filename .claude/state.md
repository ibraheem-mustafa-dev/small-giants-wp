...
latest_commit: "HEAD ffdbc8d2 (theme-thread docs). THEME thread 2026-06-01: 1f985c9a (mobile-nav full-fix D143) + ffdbc8d2 (docs D143/D144). CLONING thread last: b83cd312 (hero \$is_split media + scalar-media role; session commits 83a55820/5859c42d → d6358f32 → b83cd312). Branch feat/fr22-4-1-universal-wrapper, NOT merged (shared by both threads)."
