...
- Excluded: `sgs/before-after` (dropped, Bean 2026-09-26: comparing two animations by dragging has no real use). Its own `render.php` type allow-list omits `lottie` and its `MediaTypeControl` instances pass options without it.
