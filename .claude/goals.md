...
**Goal A — Container/wrapper standardisation programme (gates full pixel-diff closure):** 5-workstream programme launched D152. WS-1 (audit + DB column) SHIPPED. Active: WS-2 (sgs/container capability parity — add missing wrapper attrs to composites), WS-3 (converter wrapper logic reads container_kind), WS-4 (pixel-diff closure to ≤5%), WS-5 (docs + QA). Plan (archived — superseded): [`.claude/plans/archive/2026-06-02-container-wrapper-standardisation.md`](.claude/plans/archive/2026-06-02-container-wrapper-standardisation.md). LIVE cloning plan: [`.claude/plans/2026-06-09-clone-fix-build-plan.md`](.claude/plans/2026-06-09-clone-fix-build-plan.md) + [`.claude/plans/2026-06-09-clone-fix-sign-off-ledger.md`](.claude/plans/2026-06-09-clone-fix-sign-off-ledger.md). Canonical procedure: Spec 22 §FR-22-21. Composite-mirror rule: no composite with a built-in wrapper diverges from sgs/container capabilities (propagated via block_composition + /sgs-update).
