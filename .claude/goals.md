...
| **WP 7.0 alignment (all 69 blocks + 10 skills)** | DONE | Folded into the Architecture programme row above (apiVersion 3 + role: content + script-module text domains across all blocks; AI Connectors infrastructure registered). Previously tracked as a separate row — merged here 2026-09-07 to remove the duplicate. |
