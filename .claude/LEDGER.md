...
### Spec 30 P5 — customer account area and saved-item alerts (DONE 2026-09-26)

FR-30-14/15 shipped and live on sandybrown (Spec 30 v2.3; design and Bean's sign-off `reports/2026-09-26-fr30-14-account-area-design.md`; plan `plans/2026-09-26-fr30-14-15-account-area-build.md`). New `sgs/account` block, Saved items page (4228) and account tab, strip under the basket, price-drop line, two alert opt-ins, the 12-hourly N8N alert scan, Notify me finally sent on restock, share by link. Live proof 9/9; axe 0 outside the header at 375/768/1440. QA shopper `sgs-qa-customer` (creds in `secrets/sandybrown.env`, order 4229). Open, Bean's eye only: the page polish noted in the plan's Outcome. Watch: WooCommerce 11.2 core shopper lists (experimental) and back-in-stock (Spec 30 FR-30-15 watch item). Not mine, found: `sgs/mega-group` focus ring uses the accent colour (same contrast risk as fixed in the account blocks).
