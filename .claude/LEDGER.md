...
- **Lane B:** U-13 CLOSED (header colour follows the section, photo tone at upload, logo answers its ground, direction-keyed restyle; Spec 37 FR-37-50/51; live on sandybrown at 51d80ff73, fixture back on `two-bar`). Step 0d measured (f839facc7). Next: U-16 design gate.
