...
| **Form CPT + choice-flow** — Phases 0-4 and the v1.8.0 follow-up (Continue model, showcase layout, product-linked flows, guided buybox) live and QA'd on sandybrown and eye-care-test at 84c6fc505 (plan archived: `plans/archive/2026-09-26-choice-flow-ux-and-guided-buybox.md`). Next: Phase 5 (form rebuild, delete guard) in a fresh session; pipeline and analytics parked in `plans/2026-09-26-form-choiceflow-pipeline-and-analytics.md` | `specs/42-SGS-FORM-CPT-AND-PRICING.md` + `specs/43-SGS-CHOICE-FLOW.md` + `plans/2026-09-14-spec42-43-form-choiceflow-phase-plan.md` |
