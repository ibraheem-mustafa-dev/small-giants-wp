# LEDGER snapshot — 2026-08-29 (auto-rotated by ledger-rotate.py)
...
`.claude/prompts/2026-08-30-shape-b-reference-then-rollout.md`. **FIRST action: convert
`sgs/accordion` as the Shape-B reference** (Bean) — the migration script for the other 37 is built
FROM it. That prompt also lists 4 claims from other docs that are verified FALSE.
