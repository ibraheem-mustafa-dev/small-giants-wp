...
**T1.2 / T1.3 — CLOSED 2026-08-02.** Phase 0 complete (D464); Phase 1 started. Do not re-run.
...
**T1.7 — Explain the `hooks` shortfall** [sonnet, ~30 min, low priority]
A rebuild produces 161 of 5,468 hooks. Now understood in KIND (most rows are WP-core imports, not
repo-derived) but the exact split has never been measured. ⚠ Do not treat as a defect until measured.
